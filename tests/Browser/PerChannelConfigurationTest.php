...
class PerChannelConfigurationTest extends DuskTestCase
{
    ...
    public function testCreatePerChannelConfiguration(): void
    {
        $admin = \App\User::find(1);
        $per_channel_configuration = factory('App\PerChannelConfiguration')->make();

        $this->browse(function (Browser $browser) use ($admin, $per_channel_configuration): void {
    ...
    public function testEditPerChannelConfiguration(): void
    {
        $admin = \App\User::find(1);
        ...
        $this->browse(function (Browser $browser) use ($admin, $per_channel_configuration, $per_channel_configuration2): void {
            $browser->loginAs($admin)
                ->visit(route('admin.per_channel_configurations.index'))
    ...
    public function testShowPerChannelConfiguration(): void
    {
        $admin = \App\User::find(1);
        $per_channel_configuration = factory('App\PerChannelConfiguration')->create();
