...
class SsListChannelTest extends DuskTestCase
{
    ...
    public function testCreateSsListChannel()
    {
        ...
        $this->browse(function (Browser $browser) use ($admin, $ss_list_channel) {
    ...
    public function testEditSsListChannel()
    {
        $admin = \App\User::find(1);
        ...
        $this->browse(function (Browser $browser) use ($admin, $ss_list_channel, $ss_list_channel2) {
            $browser->loginAs($admin)
                ->visit(route('admin.ss_list_channels.index'))
    ...
    public function testShowSsListChannel()
    {
        $admin = \App\User::find(1);
        $ss_list_channel = factory('App\SsListChannel')->create();
