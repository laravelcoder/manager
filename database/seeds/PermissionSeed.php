...
class PermissionSeed extends Seeder
{
    ...
    public function run(): void
    {
        $items = [
            ...
            ['id' => 145, 'title' => 'channels_list_access'],
            ['id' => 146, 'title' => 'channels_list_create'],
            ['id' => 147, 'title' => 'channels_list_edit'],
            ['id' => 148, 'title' => 'channels_list_view'],
            ['id' => 149, 'title' => 'channels_list_delete'],
            ['id' => 150, 'title' => 'cs_list_channel_access'],
            ['id' => 151, 'title' => 'cs_list_channel_create'],
