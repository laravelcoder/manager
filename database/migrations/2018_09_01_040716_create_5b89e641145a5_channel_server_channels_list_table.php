...
class Create5b89e641145a5ChannelServerChannelsListTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up(): void
    {
        if (! Schema::hasTable('channel_server_channels_list')) {
            Schema::create('channel_server_channels_list', function (Blueprint $table): void {
                ...
                $table->foreign('channel_server_id', 'fk_p_174738_201556_channe_5b89e64114814')->references('id')->on('channel_servers')->onDelete('cascade');
