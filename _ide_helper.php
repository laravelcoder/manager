 ...
 * Generated for Laravel 5.6.33 on 2018-08-15 00:05:56.
 *
...
namespace Illuminate\Support\Facades {
    ...
    class App
    {
         ...
         * @static
         */
        public static function abort($code, $message = '', $headers = []): void
        {
    ...
    class Blade
    {
         ...
         * @static
         */
        public static function component($path, $alias = null): void
        {
         ...
         * @static
         */
        public static function directive($name, $handler): void
        {
    ...
    class Cache
    {
         ...
         * @static
         */
        public static function put($key, $value, $minutes = null): void
        {
         ...
         * @static
         */
        public static function putMany($values, $minutes): void
        {
    ...
    class Cookie
    {
         ...
         * @static
         */
        public static function queue($parameters = null): void
        {
         ...
         * @static
         */
        public static function unqueue($name): void
        {
    ...
    class DB
    {
         ...
         * @static
         */
        public static function setQueryGrammar($grammar): void
        {
            //Method inherited from \Illuminate\Database\Connection
         ...
         * @static
         */
        public static function setSchemaGrammar($grammar): void
        {
            //Method inherited from \Illuminate\Database\Connection
         ...
         * @static
         */
        public static function setPostProcessor($processor): void
        {
            //Method inherited from \Illuminate\Database\Connection
         ...
         * @static
         */
        public static function setTablePrefix($prefix): void
        {
            //Method inherited from \Illuminate\Database\Connection
    ...
    class Event
    {
         ...
         * @static
         */
        public static function listen($events, $listener): void
        {
    ...
    class File
    {
         ...
         * @static
         */
        public static function link($target, $link): void
        {
    ...
    class Mail
    {
         ...
         * @static
         */
        public static function alwaysFrom($address, $name = null): void
        {
         ...
         * @static
         */
        public static function alwaysReplyTo($address, $name = null): void
        {
         ...
         * @static
         */
        public static function alwaysTo($address, $name = null): void
        {
         ...
         * @static
         */
        public static function html($html, $callback): void
        {
         ...
         * @static
         */
        public static function plain($view, $data, $callback): void
        {
         ...
         * @static
         */
        public static function send($view, $data = [], $callback = null): void
        {
         ...
         * @static
         */
        public static function setSwiftMailer($swift): void
        {
    ...
    class Route
    {
         ...
         * @static
         */
        public static function resources($resources): void
        {
         ...
         * @static
         */
        public static function apiResources($resources): void
        {
         ...
         * @static
         */
        public static function group($attributes, $routes): void
        {
    ...
    class Storage
    {
         ...
         * @static
         */
        public static function assertExists($path): void
        {
         ...
         * @static
         */
        public static function assertMissing($path): void
        {
         ...
         * @static
         */
        public static function setVisibility($path, $visibility): void
        {
    ...
    class URL
    {
         ...
         * @static
         */
        public static function forceScheme($schema): void
        {
    ...
    class View
    {
         ...
         * @static
         */
        public static function startComponent($name, $data = []): void
        {
         ...
         * @static
         */
        public static function slot($name, $content = null): void
        {
...
namespace Collective\Html {
    ...
    class FormFacade
    {
         ...
         * @static
         */
        public static function component($name, $view, $signature): void
        {
...
namespace Maatwebsite\Excel\Facades {
    ...
    class Excel
    {
         ...
         * @param callable|null $callbackConfigReader
...
namespace  {
    ...
    class Eloquent extends \Illuminate\Database\Eloquent\Model
    {
         ...
         * @static
         */
        public static function mergeWheres($wheres, $bindings): void
        {
