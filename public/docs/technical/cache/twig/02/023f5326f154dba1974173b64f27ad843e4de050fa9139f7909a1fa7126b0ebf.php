...
/* sami.js.twig */
class __TwigTemplate_793b3485b3e6220e5d98a757b7a816564207b8933cfd7bcc004bfe0bf6e558fa extends Twig_Template
{
    private $source;
...
window.projectVersion = '";
        // line 3
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context['project']) || array_key_exists('project', $context) ? $context['project'] : (function (): void {
            throw new Twig_Error_Runtime('Variable "project" does not exist.', 3, $this->source);
...
(function(root) {
    ...
    var treeHtml = '";
        // line 9
        echo twig_replace_filter($context['__internal_2f930691843a78ce86f400d53e6dfee28fa43d5e7924c131fbd2756e49957510']->macro_element((isset($context['tree']) || array_key_exists('tree', $context) ? $context['tree'] : (function (): void {
            throw new Twig_Error_Runtime('Variable "tree" does not exist.', 9, $this->source);
        })()), twig_get_attribute($this->env, $this->source, (isset($context['project']) || array_key_exists('project', $context) ? $context['project'] : (function (): void {
            throw new Twig_Error_Runtime('Variable "project" does not exist.', 9, $this->source);
        })()), 'config', [0 => 'default_opened_level'], 'method'), 0), ["'" => "\\'", '
' => '']);
        echo "';
...
';
    ...
    // line 21
    public function block_search_index($context, array $blocks = []): void
    {
        // line 22
        echo '            ';
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context['namespaces']) || array_key_exists('namespaces', $context) ? $context['namespaces'] : (function (): void {
            throw new Twig_Error_Runtime('Variable "namespaces" does not exist.', 24, $this->source);
        })()));
        ...
        // line 28
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable((isset($context['interfaces']) || array_key_exists('interfaces', $context) ? $context['interfaces'] : (function (): void {
            throw new Twig_Error_Runtime('Variable "interfaces" does not exist.', 28, $this->source);
        })()));
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context['classes']) || array_key_exists('classes', $context) ? $context['classes'] : (function (): void {
            throw new Twig_Error_Runtime('Variable "classes" does not exist.', 33, $this->source);
        })()));
        foreach ($context['_seq'] as $context['_key'] => $context['class']) {
            // line 34
            echo '{"type": ';
    ...
    // line 39
    public function block_search_index_extra($context, array $blocks = []): void
    {
        echo '';
    }

    // line 158
    public function block_treejs($context, array $blocks = []): void
    {
        // line 159
        echo "
    ...
    public function macro_add_class_methods_index($__class__ = null, ...$__varargs__)
    {
        ...
        try {
            ...
            if (twig_get_attribute($this->env, $this->source, (isset($context['class']) || array_key_exists('class', $context) ? $context['class'] : (function (): void {
                throw new Twig_Error_Runtime('Variable "class" does not exist.', 216, $this->source);
            })()), 'methods', [])) {
                // line 217
                echo '        ';
                $context['from_name'] = twig_replace_filter(twig_get_attribute($this->env, $this->source, (isset($context['class']) || array_key_exists('class', $context) ? $context['class'] : (function (): void {
                    throw new Twig_Error_Runtime('Variable "class" does not exist.', 217, $this->source);
                })()), 'name', []), ['\\' => '\\\\']);
                // line 218
                echo '        ';
                $context['from_link'] = $this->extensions['Sami\Renderer\TwigExtension']->pathForClass($context, (isset($context['class']) || array_key_exists('class', $context) ? $context['class'] : (function (): void {
                    throw new Twig_Error_Runtime('Variable "class" does not exist.', 218, $this->source);
                })()));
                // line 219
                echo '        ';
                $context['_parent'] = $context;
                $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, (isset($context['class']) || array_key_exists('class', $context) ? $context['class'] : (function (): void {
                    throw new Twig_Error_Runtime('Variable "class" does not exist.', 219, $this->source);
                })()), 'methods', []));
                foreach ($context['_seq'] as $context['_key'] => $context['meth']) {
                    // line 220
                    echo '            {"type": "Method", "fromName": "';
                    echo isset($context['from_name']) || array_key_exists('from_name', $context) ? $context['from_name'] : (function (): void {
                        throw new Twig_Error_Runtime('Variable "from_name" does not exist.', 220, $this->source);
                    })();
                    echo '", "fromLink": "';
                    echo isset($context['from_link']) || array_key_exists('from_link', $context) ? $context['from_link'] : (function (): void {
                        throw new Twig_Error_Runtime('Variable "from_link" does not exist.', 220, $this->source);
                    })();
                    echo '", "link": "';
                    ...
                    echo '", "doc": "';
                    echo twig_escape_filter($this->env, json_encode($this->extensions['Sami\Renderer\TwigExtension']->parseDesc($context, twig_get_attribute($this->env, $this->source, $context['meth'], 'shortdesc', []), (isset($context['class']) || array_key_exists('class', $context) ? $context['class'] : (function (): void {
                        throw new Twig_Error_Runtime('Variable "class" does not exist.', 220, $this->source);
                    })()))), 'html', null, true);
                    echo '"},
        ';
                }
    ...
    <ul>';
            // line 229
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable((isset($context['tree']) || array_key_exists('tree', $context) ? $context['tree'] : (function (): void {
                throw new Twig_Error_Runtime('Variable "tree" does not exist.', 229, $this->source);
            })()));
            foreach ($context['_seq'] as $context['_key'] => $context['element']) {
                ...
                if (twig_get_attribute($this->env, $this->source, $context['element'], 2, [], 'array')) {
                    ...
                    echo '" ';
                    if (((isset($context['depth']) || array_key_exists('depth', $context) ? $context['depth'] : (function (): void {
                        throw new Twig_Error_Runtime('Variable "depth" does not exist.', 231, $this->source);
                    })()) < (isset($context['opened']) || array_key_exists('opened', $context) ? $context['opened'] : (function (): void {
                        throw new Twig_Error_Runtime('Variable "opened" does not exist.', 231, $this->source);
                    })()))) {
                        echo 'class="opened"';
                    }
                    echo '>
                    ...
                    // line 232
                    echo(isset($context['depth']) || array_key_exists('depth', $context) ? $context['depth'] : (function (): void {
                        throw new Twig_Error_Runtime('Variable "depth" does not exist.', 232, $this->source);
                    })()) * 18;
                    echo 'px" class="hd">
                    ...
                    if (! twig_get_attribute($this->env, $this->source, (isset($context['project']) || array_key_exists('project', $context) ? $context['project'] : (function (): void {
                        throw new Twig_Error_Runtime('Variable "project" does not exist.', 233, $this->source);
                    })()), 'config', [0 => 'simulate_namespaces'], 'method')) {
                        echo '<a href="';
                    ...
                    <div class="bd">
                        ';
                    // line 236
                    echo $context['__internal_abe917f28939a73d7c6553bae73fe7546c6534dc84cc1e86ef2ae60b26089e85']->macro_element(twig_get_attribute($this->env, $this->source, $context['element'], 2, [], 'array'), (isset($context['opened']) || array_key_exists('opened', $context) ? $context['opened'] : (function (): void {
                        throw new Twig_Error_Runtime('Variable "opened" does not exist.', 236, $this->source);
                    })()), ((isset($context['depth']) || array_key_exists('depth', $context) ? $context['depth'] : (function (): void {
                        throw new Twig_Error_Runtime('Variable "depth" does not exist.', 236, $this->source);
                    })()) + 1));
                    // line 237
                    echo '</div>
                </li>
            ';
                    ...
                    echo '" ';
                    if (((isset($context['depth']) || array_key_exists('depth', $context) ? $context['depth'] : (function (): void {
                        throw new Twig_Error_Runtime('Variable "depth" does not exist.', 240, $this->source);
                    })()) < (isset($context['opened']) || array_key_exists('opened', $context) ? $context['opened'] : (function (): void {
                        throw new Twig_Error_Runtime('Variable "opened" does not exist.', 240, $this->source);
                    })()))) {
                        echo 'class="opened"';
                    }
                    echo '>
                    <div style="padding-left:';
                    // line 241
                    echo twig_escape_filter($this->env, (8 + ((isset($context['depth']) || array_key_exists('depth', $context) ? $context['depth'] : (function (): void {
                        throw new Twig_Error_Runtime('Variable "depth" does not exist.', 241, $this->source);
                    })()) * 18)), 'html', null, true);
...
{% endmacro %}
", 'sami.js.twig', '/home/vagrant/repos/manager/vendor/sami/sami/Sami/Resources/themes/default/sami.js.twig');
    }
}
