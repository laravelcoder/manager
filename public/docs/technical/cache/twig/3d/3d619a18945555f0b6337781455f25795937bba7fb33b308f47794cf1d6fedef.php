...
/* layout/layout.twig */
class __TwigTemplate_8734309bb9117ea55aa0e9f21f1b78731d117350954decbb98880859806cba89 extends Twig_Template
{
    private $source;
...
';
    ...
    public function block_menu($context, array $blocks = []): void
    {
        ...
        if ((isset($context['has_namespaces']) || array_key_exists('has_namespaces', $context) ? $context['has_namespaces'] : (function (): void {
            throw new Twig_Error_Runtime('Variable "has_namespaces" does not exist.', 35, $this->source);
        })())) {
            // line 36
            echo '                        <li><a href="';
...
';
    ...
    // line 48
    public function block_leftnav($context, array $blocks = []): void
    {
        // line 49
...
';
    ...
    // line 52
    public function block_control_panel($context, array $blocks = []): void
    {
        // line 53
        echo '    <div id="control-panel">
        ';
        // line 54
        if ((twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context['project']) || array_key_exists('project', $context) ? $context['project'] : (function (): void {
...
';
    ...
    // line 76
    public function block_footer($context, array $blocks = []): void
    {
        // line 77
        echo '    <div id="footer">
...
{% endblock %}
", 'layout/layout.twig', '/home/vagrant/repos/manager/vendor/sami/sami/Sami/Resources/themes/default/layout/layout.twig');
    }
}
