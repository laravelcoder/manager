...
/* opensearch.twig */
class __TwigTemplate_7056356acbc53961e7fc05e825971affec0793887a97ee4c6286f35c3ed9e3f9 extends Twig_Template
{
    private $source;
    ...
    <OpenSearchDescription xmlns="http://a9.com/-/spec/opensearch/1.1/" xmlns:referrer="http://a9.com/-/opensearch/extensions/referrer/">
        ...
        ';
            ...
            })()), 'config', [0 => 'base_url'], 'method'), ['%version%' => twig_get_attribute($this->env, $this->source, (isset($context['project']) || array_key_exists('project', $context) ? $context['project'] : (function (): void {
                throw new Twig_Error_Runtime('Variable "project" does not exist.', 10, $this->source);
