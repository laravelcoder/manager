...
class ChannelsListsController extends Controller
{
    ...
    public function show($id)
    {
        ...
        $cs_list_channels = \App\CsListChannel::where('channel_id', $id)->get();$csis = \App\Csi::where('channel_id', $id)->get();$ss_list_channels = \App\SsListChannel::where('channel_id', $id)->get();$channel_servers = \App\ChannelServer::whereHas('channel',
                    function ($query) use ($id) {
                        $query->where('id', $id);
                    })->get();$csos = \App\Cso::where('channel_id', $id)->get();
