...
class ChannelServersController extends Controller
{
    ...
    public function show($id)
    {
        ...
        $channels = \App\ChannelsList::get()->pluck('channel_name', 'id');
$csis = \App\Csi::where('channel_server_id', $id)->get();$csos = \App\Cso::where('channel_server_id', $id)->get();$cs_list_channels = \App\CsListChannel::where('channelserver_id', $id)->get();$ss_list_channels = \App\SsListChannel::where('channel_server_id', $id)->get();
