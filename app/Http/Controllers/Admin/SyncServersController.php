...
class SyncServersController extends Controller
{
    ...
    public function show($id)
    {
        ...
        return view('admin.sync_servers.show', compact('sync_server', 'filters', 'general_settings', 'aggregation_servers', 'baby_sync_servers', 'output_settings', 'realtime_notifications', 'video_settings', 'ftps', 'report_settings'));
    }
